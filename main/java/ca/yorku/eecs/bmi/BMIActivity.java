...
public class BMIActivity extends AppCompatActivity
{
    ...
    public void buttonClicked(View v)
    {
        ...
        String weightT = myModel.toPound();
        String heightT = myModel.toFeetInch();

        String out = "Your weight is " + weightT + " lb, your Height is " + heightT + ", and your BMI is " + myBMI;

        ((TextView) findViewById(R.id.answer)).setText(out);
    }
}
